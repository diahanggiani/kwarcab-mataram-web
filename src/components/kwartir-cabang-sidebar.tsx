  ...
  navMain: [
    {
      title: "Dashboard",
      icons: icons.Gauge,
      url: "/kwartir-cabang/dashboard",
    },
    {
      title: "Kwartir Ranting",
      icons: icons.User,
      url: "/kwartir-cabang/kwartir-ranting",
    },
    {
      title: "Gugus Depan",
      icons: icons.Users,
      url: "/kwartir-cabang/gugus-depan",
    },
    {
      title: "Kegiatan",
      icons: icons.Tent,
      url: "/kwartir-cabang/kegiatan",
    },
    {
      title: "Akun Kwartir Ranting",
      url: "/kwartir-cabang/akun-kwartir-ranting",
      icons: icons.IdCard,
    },
    {
      title: "Verivikasi KTA",
...
export function KwarcabSidebar({
  ...props
