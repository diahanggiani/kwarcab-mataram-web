      ...
      <div>
        ...
        <div className="w-full mx-auto mt-2">
          <span className="w-full bg-amber-950 rounded-lg px-3 py-2 text-white block">
            {profile?.alamat || "Belum ada alamat yang ditentukan."}
          </span>
        </div>
        <h2 className="text-xl font-bold mt-2">Kepala Kwartir Cabang</h2>
        <div className="w-full mx-auto mt-2">
          <span className="w-full bg-amber-950 rounded-lg px-3 py-2 text-white block">
            {profile?.kepala_kwarcab ||
              "Belum ada kepala kwartir cabang yang ditentukan."}
          </span>
        </div>
      </div>
      <div className="flex justify-center mt-6">
        <Link href="/kwartir-cabang/profile/edit-profile">
