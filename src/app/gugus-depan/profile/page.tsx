  ...
  return (
    <div className="flex flex-col gap-6 mb-4">
      ...
      <div>
        ...
        <div className="w-full mx-auto mt-2">
          <span className="w-full bg-amber-950 rounded-lg px-3 py-2 text-white block">
            {profile?.alamat || "Belum ada alamat sekolah"}
          </span>
        </div>
        <h2 className="text-xl font-bold mt-2">Kepala Sekolah</h2>
        <div className="w-full mx-auto mt-2">
          <span className="w-full bg-amber-950 rounded-lg px-3 py-2 text-white block">
            {profile?.kepala_sekolah || "Belum ada kepala sekolah"}
          </span>
        </div>
      </div>
      <div className="flex justify-center mt-6">
        <Link href="/gugus-depan/profile/edit-profile">
