...
export default function Kegiatan() {
  ...
  useEffect(() => {
    ...
    fetchKegiatan();
    fetchProfile();
  }, [session, debouncedSearch, setMounted]);
    ...
    <div className="w-full mx-auto p-6 bg-white rounded-lg shadow-lg">
      <div className="mb-8 text-center">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          KEGIATAN {profile?.nama_gusdep.toUpperCase()}
        </h1>
            ...
            >
              <CardContent className="flex justify-between items-center w-full">
                ...
                <div className="flex gap-4">
                  <Link href={`/gugus-depan/kegiatan/${kegiatan.id_kegiatan}`}>
                    <Eye className="h-6 w-6 cursor-pointer text-white hover:text-gray-300" />
                  </Link>
                  <Link
                    href={`/gugus-depan/kegiatan/${kegiatan.id_kegiatan}/edit-kegiatan`}
                  >
